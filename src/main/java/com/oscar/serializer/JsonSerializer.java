...
public class JsonSerializer {
    ...
    public static <T> String serializeList(List<T> sources) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        StringBuilder sb= new StringBuilder();
        sb.append("[");
        for(T source: sources) {
            sb.append(serilaize(source));
            sb.append(",");
        }
